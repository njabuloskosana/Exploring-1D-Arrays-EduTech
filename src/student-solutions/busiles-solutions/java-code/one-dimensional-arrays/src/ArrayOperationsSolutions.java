public class ArrayOperationsSolutions {
     ...
     * @return
     */
    public int numberOfOddNumbers(int[] arr)
    {
        return 0;
    }
     ...
     * @return
     */
    public int numberOfEvenNumbers(int[] arr)
    {
        return 0;
    }
     ...
     * @return
     */
    public int numberOfPositiveNumbers(int[] arr)
    {
        return 0;
    }
     ...
     * @return
     */
    public int numberOfNegativeNumbers(int[] arr)
    {
        return 0;
    }
     ...
     * @return
     */
    public int mostOccuring(int[] arr)
    {
        return 0;
    }
